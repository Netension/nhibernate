...
namespace Netension.NHibernate.Prometheus.Enumerations
{
    ...
    public class NHibernateMetricsEnumeration : PrometheusMetricEnumeration
    {
        ...
        public static NHibernateMetricsEnumeration TotalTransactionsCount => new NHibernateMetricsEnumeration(1, "total_transactions_count", "Total count of transactions.", new List<string> { "Operation" });
